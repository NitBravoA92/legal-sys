...
class ShowOrderToValidate extends Mailable
{
    ...
    {
        return $this->markdown('emails.new-order-to-validate')->from($this->app_email, $this->app_name)->subject('Nueva Orden de Servicio para Validar');
    }
}
