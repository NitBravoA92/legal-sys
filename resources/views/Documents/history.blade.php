        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
                <h5 class="mb-0">{{ __('content.document_history') }}</h5>
            </div>

            <div class="card-body pt-4 p-3">
                <!-- init table -->
                <div class="table-responsive p-0">
                  <table class="table align-items-center justify-content-center mb-0" id="docment_history-table">
                    <thead>
                      <tr>
                    ...
                    <tbody>
                      ...
                      @foreach ($client_documents as $value)
                        <tr>
                          ...
                          <td class="align-middle">
                            <a class="btn btn-sm bg-gradient-dark text-white mb-0 px-3" data-bs-toggle="tooltip" data-bs-original-title="{{ __('content.download') }}" href="{{ route('documents.download-client', $value->id) }}">
